...
import { PLAYFIELD_COLUMNS, PLAYFIELD_ROW, SAD, convertPositionToIndex } from "./utilities.js";

let hammer;
let requestId;
let timeoutId;
const tetris = new Tetris();
const cells = document.querySelectorAll('.grid>d-div');
...
function dragGhostTetromino() {
	...
	for (let row = 0; row < tetrominoMatrixSize; row++) {
		for (let column = 0; column < tetrominoMatrixSize; column++) {
			...
			cell[cellIndex].classList.add('ghost');
		}
	}
}
